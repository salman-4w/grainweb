Ext.MessageBox = function(){
    ...
    var bodyEl, msgEl, textboxEl, textareaEl, progressBar, pp, iconEl, spacerEl, dropdownEl;
        ...
        getDialog : function(titleText){
           if(!dlg){
                ...
                bodyEl = dlg.body.createChild({
                    html:'<div class="ext-mb-icon"></div><div class="ext-mb-content"><span class="ext-mb-text"></span><br /><div class="ext-mb-fix-cursor"><input type="text" class="ext-mb-input" /><textarea class="ext-mb-textarea"></textarea><select id="test-sel" class="ext-mb-input"></select></div>'
                });
                ...
                textareaEl.enableDisplayMode();
								...
								dropdownEl = Ext.get(contentEl.childNodes[2].childNodes[2]);
                dropdownEl.enableDisplayMode();
...
Ext.Msg.show({
   ...
   icon: Ext.MessageBox.INFO
        ...
        show : function(options){
            ...
            opt.prompt = opt.prompt || ((opt.multiline || opt.options) ? true : false);
            if(opt.prompt) {
							if(opt.multiline) {
                textboxEl.hide();
								dropdownEl.hide();
                ...
                for( var i = 0; i < opt.options.length; i++ ) {
                  ...
                  switch(typeof(option)) {
                    	...
                    	text = option.text;
									...
									dropdowwn.options[i] = new Option(text, value);
                }
								dropdownEl.show();

								activeTextEl = dropdownEl;
              } else {
                textareaEl.hide();
                dropdownEl.hide();
                textboxEl.show();
